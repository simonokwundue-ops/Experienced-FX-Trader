//+------------------------------------------------------------------+
//|                    ForexTrader_v4.0_Enhanced_Scalper.mq5         |
//|       Professional Scalping EA with Market Regime Logic          |
//|       Adaptive Decision Gating & Dynamic ATR-Based Risk Control  |
//+------------------------------------------------------------------+
#property copyright "ForexTrader EA v4.0 Enhanced Scalper - Professional Production"
#property link      "https://github.com/simonokwundue-ops/Experienced-FX-Trader"
#property version   "4.00"
#property description "Professional scalper with market regime detection & adaptive strategies"
...
#property description "Optimized for M1/M5 timeframes with intelligent risk allocation"
#property strict
...
//+------------------------------------------------------------------+
input group "=== Multi-Symbol Scalping (v4.0) ==="
...
input ENUM_TIMEFRAMES RegimeTimeframe = PERIOD_M15; // Regime Analysis Timeframe (M15/H1 for scalping)
...
input double   MA_SlopeMinimum = 1.5;         // Min MA Slope (Pips) - REDUCED for scalping
input double   MA_DistanceMinimum = 1.0;      // Min Distance Between MAs (Pips) - NEW
...
input double   BreakoutThresholdPips = 3.0;   // Min Breakout Size (Pips) - Smaller for scalping
...
int regimeUpdateIntervalSeconds = 180; // Update regime every 3 minutes for scalping
